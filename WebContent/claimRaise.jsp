...
<td> Last Name <input type="text" name="lname" value="<c:out value='${x.getLname()}'></c:out>"/></td>
</tr>
<tr> <td></td></tr>
<tr> <td></td></tr>
<tr> <td></td></tr>
...
<input type="checkbox" name="work_acc" value="Yes"> 
<span class="checkmark"></span>
</label>
</div>
<div class="form-checkbox1">
<label class="container"><p>No</p>
<input type="checkbox" name="work_acc" value="No">
<span class="checkmark"></span>
</label>
</div>
Auto Accident 
<div class="form-checkbox1"> 
<label class="container"><p>Yes</p>
<input type="checkbox" name="auto_acc" value="Yes"> 
<span class="checkmark"></span>
</label>
</div>
<div class="form-checkbox1">
<label class="container"><p>No</p>
<input type="checkbox" name="auto_acc" value="No">
<span class="checkmark"></span>
</label>
</div>
