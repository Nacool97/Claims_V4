...
<div class="form-group">
<div class="form-row form-row-1">
						<a href="AcceptClaimRequest?claim_id=${x.getClaimid()}"><input type="button" class="register2" value="Accept"/></a>	
						</div>
						<div class="form-row form-row-2">					
						<a href="RejectClaimRequest?claim_id=${x.getClaimid()}"><input type="button"  class="register1" value="Reject"/></a>
					</div>
					</div>
					</div>
							</div>
